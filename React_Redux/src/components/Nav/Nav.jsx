    ...
    return (
        <div className="navbar bg-black rounded-2xl fixed top-0 left-0 right-0 z-50">
            ...
            <ul className="p-1 rounded-t-none max-sm:hidden">
                ...
                <li className="btn btn-ghost text-lg hover:underline"><Link to="#">Movies</Link></li>
                <li className="btn btn-ghost text-lg hover:underline"><Link to="#">Animations</Link></li>
                <li className="btn btn-ghost text-lg hover:underline"><Link to="#">Game</Link></li>}
            </ul>
                    ...
                    <li>
                        <details>
                            ...
                            <ul className="p-1 bg-base-100 rounded-t-none text-base bg-black">
                                ...
                                <li className="hover:underline"><Link to="#">Movies</Link></li>
                                <li className="hover:underline"><Link to="#">Animations</Link></li>
                                <li className="hover:underline"><Link to="#">Game</Link></li>
                            </ul>
                        </details>
                    </li>
                </ul>
